    ...
    <div class="main-content-inner">
        <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active">Kelola Stock In</li>
            </ul>
        </div>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><img src="<?php echo base_url('uploads/' . $data_brg->gambar) ?>" style="width:50px"></td>
                                        <td class="text-center" width="160px">
                                            <button class="btn btn-warning btn-xs" id="detail1" data-toggle="modal" data-target="#modal-detail" data-id="<?= $data_brg->kode_nama ?>" data-barangnama="<?= $data_brg->barang_nama ?>" data-qty="<?= $data_brg->qty ?>" data-date="<?= $data_brg->created_date ?>" data-keterangan="<?= $data_brg->keterangan ?>" data-gambar="<?= $data_brg->gambar ?>" title="Lihat">
                                                <i class="fa fa-eye"></i>
                                            </button>
        ...
        $(document).on('click', '#btndel', function() {
            ...
            Swal.fire({
                ...
                if (willDelete.isConfirmed) {
                    $.ajax({
                        type: "post",
                        url: "<?php echo base_url();  ?>stock/in_hapus",
                        dataType: "text",
                        data: {
                            stock: stock,
                            barang: barang
                                ...
                                case 'OK':
                                    setTimeout(function() {
                                        Swal.fire('Success', 'Berhasil', 'success').then(function() {
                                            window.location.href = "<?php echo base_url(); ?>stock/kelola_stock_in";
                                        });
                                    }, 1000);
                                    break;
                                default:

    ...
    <div class="main-content-inner">
        <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active">Tambah Stock In</li>
            </ul>
        </div>
                ...
                <div class="row">
                    <div class="col-md-4 col-md-offset-4">
                        <form role="form" id="frmtbh">
                            ...
                            <div class="form-group">
                                <label>Gambar</label>
                                <input class="form-control" type="file" value="" id="gambar" name="gambar" required>
                            </div>
                            <div class="form-group">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $("#frmtbh").submit(function(e) {
            e.preventDefault();
            $.ajax({
                type: "post",
                url: "<?php echo base_url() ?>/stock/store",
                    ...
                    switch (header[0]) {
                        case 'OK':
                            Swal.fire("Success", "Berhasil", "success").then(function() {
                                window.location.href = "<?php echo base_url(); ?>stock/tambah_stock_in";
                            });
                            break;
                        case 'errkode':
                        ...
                        case 'errqty':
                            ...
                            break;
                        case 'errgam':
                            Swal.fire("Gagal", "Gambar Harus Diisi", "error").then(function() {
                                $("#gambar").focus().select();
                            });
                            break;
                        default:
